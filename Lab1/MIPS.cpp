...
class RF
{
    public:
        ...
        {   
            // implement the funciton of RF read and write, order is important
...
class INSMem
{
      public:
          ...
          bitset<32> ReadMemory (bitset<32> ReadAddress) 
              {    
               // Read the byte at the ReadAddress and the following three bytes
			   string tempInst;
			   for(int j = 0; j < 4; j++)
			   {
...
class DataMem    
{
      public:
          ...
          {                   
               // implement memory read to get read_data
